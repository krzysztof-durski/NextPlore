...
3. **Location ↔ Tag:** **Many-to-Many**
   * *Implementation:* Managed via junction table `place_tag`.
   * *Reasoning:* A location can have multiple tags; one tag can apply to many locations.
...
* **Smart Recommendations:** Filter results by tags (e.g., "Find *Cozy* and *Quiet* cafes").

### 3. Location Details
* View metadata (Address, Description, Opening Hours).
